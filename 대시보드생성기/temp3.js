...
(function () {
  ...
  window.calculateMultivariateAnomalies = function(branches) {
    ...
    var counts = branches.map(function(b){return b.count});
    var fees = branches.map(function(b){return b.fee});
    var convs = branches.map(function(b){return b.conv});
  ...
  window.calculateAgentRFM = function(agents) {
    ...
    var maxCount = Math.max.apply(null, agents.map(function(a){return a.count})) || 1;
    var maxFee = Math.max.apply(null, agents.map(function(a){return a.fee})) || 1;
    
    agents.forEach(function(a) {
      // Frequency Score (0-100)
      var fScore = (a.count / maxCount) * 100;
